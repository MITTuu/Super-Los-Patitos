...
namespace Prototipo.Modelo {
    internal class Cnx {
        ...
        public DataTable GetDocumentosIF(DateTime fechaInicio, DateTime fechaFin) {
            DataTable documentosData = null;
            ...
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    ...
                    SqlCommand command = new SqlCommand("GetDocumentosFI", connection);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetProductoMasVendido() {
            DataTable productoData = null;

            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    connection.Open();

                    SqlCommand command = new SqlCommand("GetProductoMasVendido", connection);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetTop5ClientesQueMasCompran() {
            DataTable clientesData = null;

            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    connection.Open();

                    SqlCommand command = new SqlCommand("GetTop5ClientesQueMasCompran", connection);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetTop10ProductosUltimoMes() {
            DataTable productosData = null;
            ...
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    ...
                    SqlCommand command = new SqlCommand("GetProductosVendidosUltimos30Dias", connection);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetAllPersonal() {
            ...
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    ...
                    SqlCommand command = new SqlCommand("DataPersonal", connection);
                    command.CommandType = CommandType.StoredProcedure;
                    SqlDataAdapter adapter = new SqlDataAdapter(command);
                    adapter.Fill(dt);
                }
        ...
        public bool UpdatePersonal(int idPersonal, string nombre, string primerApellido, string segundoApellido, string correo, string contrasena, string telefono, bool estado, string identificacion, int idTipoIdentificacion, int idRol) {
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    connection.Open();

                    SqlCommand command = new SqlCommand("UpdatePersonal", connection);
                    command.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable GetCedulaBuscar(string identificacion) {
            DataTable resultado = new DataTable();
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    connection.Open();
                    SqlCommand command = new SqlCommand("GetCedulaBuscar", connection);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@Identificacion", identificacion);
        ...
        public DataTable GetNombreBuscar(string nombre) {
            DataTable resultado = new DataTable();
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    connection.Open();
                    SqlCommand command = new SqlCommand("GetNombreBuscar", connection);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@Nombre", nombre);
        ...
        public DataTable DataPersonal(int idPersonal) {
            DataTable dt = new DataTable();
        ...
        public bool InsertPersonal(string nombre, string primerApellido, string segundoApellido, string correo, string Contrasena, string telefono, string identificacion, int idTipoIdentificacion, int idRol, int Estado) {
            try {
                using (SqlConnection connection = new SqlConnection(connectionString)) {
                    connection.Open();

                    SqlCommand command = new SqlCommand("InsertPersonal", connection);
                    command.CommandType = CommandType.StoredProcedure;
                ...
                MessageBox.Show("Error al insertar Empleado(a): " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
